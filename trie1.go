...
func main() {
	t := New()
	t.Insert("an apple", 10)
	t.Insert("an apple pie", 12)
	t.Insert("an apple table", 15)
	t.Insert("an apple tree", 23)
	t.Insert("I am a", 23)
	t.Insert("this is a", 23)
	t.Insert("go to the", 23)
	fmt.Println(t.Get("an apple"))
}
